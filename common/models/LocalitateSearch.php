...
/**
 * LocalitateSearch represents the model behind the search form of `common\models\Localitate`.
 */
class LocalitateSearch extends Localitate
{
    /**
     * {@inheritdoc}
     */
