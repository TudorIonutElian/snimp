...
/**
 * InstitutiiServiciiSearch represents the model behind the search form of `common\models\InstitutiiServicii`.
 */
class InstitutiiServiciiSearch extends InstitutiiServicii
{
    /**
     * {@inheritdoc}
     */
