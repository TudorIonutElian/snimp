...
/**
 * SesizareSearch represents the model behind the search form of `common\models\Sesizare`.
 */
class SesizareSearch extends Sesizare
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'sesizare_user_id', 'sesizare_status', 'sesizare_institutie', 'sesizare_serviciu'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'sesizare_serviciu' => $this->sesizare_serviciu,
        ]);
