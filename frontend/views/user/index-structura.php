        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    $content = '<div>';
                    $content .= '<span>Username: ' . $model->username . '</span><br>';
                    $content .= '<span>Nume: ' . $model->nume . '</span><br>';
                    $content .= '<span>Prenume: ' . $model->prenume . '</span><br>';
                    $content .= '<span>Email: ' . $model->email . '</span><br>';
                    $content .= '<span>Rol: <b>' . $model->authAssignment->item_name . '</b></span><br>';
                    return $content;
                }
            ],
            [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($model) {
                    if (isset($model->institutie_subordonata_id)) {
                        return $model->institutieSubordonata->institutie_denumire_iss;
                    }
